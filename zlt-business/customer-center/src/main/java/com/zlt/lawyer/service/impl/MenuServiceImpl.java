...
@Slf4j
@Service
public class MenuServiceImpl extends ServiceImpl<MenuMapper, CusMenu> implements IMenuService {
     ...
     */
    @Override
    public List<CusMenu> findByRoles(Set<Long> roleIds) {
     ...
     */
    @Override
    public List<CusMenu> findByRoles(Set<Long> roleIds, Integer type) {
        return roleMenuMapper.findMenusByRoleIds(roleIds, type);
    }

    @Override
    public List<CusMenu> findByRoleCodes(Set<String> roleCodes, Integer type) {
